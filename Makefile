...
clean:
	...
	rm -rf structures/array/__pycache__ # remove compiled python directory
	rm -rf test/array/__pycache__ # remove compiled python directory
	rm -rf structures/queue/__pycache__ # remove compiled python directory
	rm -rf test/queue/__pycache__ # remove compiled python directory
	rm -rf structures/stack/__pycache__ # remove compiled python directory
	rm -rf test/stack/__pycache__ # remove compiled python directory
